...
if fvertical==False :
    ...
    ax0.tick_params(axis="x", bottom=True, top=True, direction="in", color=palette["gray"], labelcolor=palette["black"], width=1, zorder=0, pad=4)
...
ax0.tick_params(axis="y", left=True, right=True, direction="in", color=palette["gray"], labelcolor=palette["black"], width=1, zorder=0, pad=4)
...
if fvertical==False:
    if doscar0.Ns==1 :
        ...
        ax1.tick_params(axis="x", bottom=True, top=True, direction="in", color=palette["gray"], labelcolor=palette["black"], width=1, zorder=0, pad=4)
else: # vertical
    ax0.set_yticklabels([])
    if doscar0.Ns==1 :
...
if doscar0.Ns==2: 
    ax1.tick_params(axis="y", left=True, right=True, direction="in", color=palette["gray"], labelcolor=palette["black"], width=1, zorder=0, pad=4)
    for edge in ["bottom","top","left","right"] :
