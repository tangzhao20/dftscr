...
if lmax:
    ...
    y_max_list = []
    for z in z_max_list:
        ylist_1d = lambda y: -interp_func(z, y)[0]  # Negative for maximizing
...
im_extent = [y_range[0] - y_spacing*0.5, y_range[1] + y_spacing*0.5, z_range[0] - z_spacing*0.5, z_range[1] + z_spacing*0.5]
